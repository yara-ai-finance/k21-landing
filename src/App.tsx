    ...
    >
          ...
          >
            <h1 style={{ fontSize: 34, margin: 0, lineHeight: 1.05 }}>
              {t(
                ...
                "Transforme seu negócio com Automação IA"
              )}
            </h1>
      ...
      >
        <h2 style={{ fontSize: 24, marginBottom: 12 }}>
          {t("What K_21 Assist Does", "O que o K_21 Assist faz")}
        </h2>
        ...
        >
          {[
            {
              title: t("AI Sales Assistant", "Assistente de Vendas IA"),
              desc: t("Capture, qualify & convert leads 24/7", "Captura, qualifica e converte leads 24/7"),
            },
            {
              title: t("Content Engine", "Gerador de Conteúdo"),
              desc: t(
                "Automate posts, ads, emails and landing text",
                "Automatize posts, anúncios, emails e textos"
              ),
            },
            {
              title: t("Multilingual Support", "Suporte Multilingue"),
              desc: t("English, PT, ES — global-ready", "Inglês, PT, ES — pronto para o mundo"),
            },
            {
              title: t("No-Code Deployment", "Deploy sem Código"),
              desc: t(
                "Live site in minutes — Vercel powered",
                "Site no ar em minutos — rodando na Vercel"
              ),
            },
          ].map((f, i) => (
            <div
        ...
        >
          ...
          >
            ...
            <div style={{ color: "rgba(255,255,255,0.7)", marginTop: 8 }}>
              Basic AI assistant, 100 messages/month
            </div>
          ...
          >
            ...
            <div style={{ color: "rgba(255,255,255,0.7)", marginTop: 8 }}>
              Multi-seat, priority support, white-label
            </div>
      ...
      >
        ...
        >
          <li>
            {t(
              "Sign up & connect your channels (website, social)",
              "Registre-se e conecte canais (site, redes sociais)"
            )}
          </li>
          <li>
            {t(
              "Pick a template and customize your assistant",
              "Escolha um template e personalize o assistente"
            )}
          </li>
          <li>
            {t(
              "Start capturing leads and scaling revenue",
              "Comece a capturar leads e escalar receita"
            )}
          </li>
        </ol>
      </section>
      ...
      >
        ...
        <div style={{ fontSize: 13 }}>
          {t(
            "Built for creators & agencies • Sell in USD",
            "Criado para criadores e agências • Venda em USD"
          )}
        </div>
      </footer>
    </div>
